...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-990 flex w-full border-b border-stroke bg-white dark:border-stroke-dark dark:bg-gray-dark">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        ...
        <div className="hidden xl:block">
          <div>
            ...
            <p className="font-medium">Your Metadata Governance Solution</p>
          </div>
        </div>
