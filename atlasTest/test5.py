...
columns = [
    AtlasEntity(
        ...
        qualified_name="db_student.sales_data.product_id@Sandbox_storage",
        guid="-2",
        attributes={
            "type": "int",
            "owner": "hive"
    ...
    AtlasEntity(
        name="product_name",
        typeName="hive_column",
        qualified_name="db_student.sales_data.product_name@Sandbox_storage",
        guid="-3",
        attributes={
            "type": "string",
            "owner": "hive"
    ...
    AtlasEntity(
        name="sale_amount",
        typeName="hive_column",
        qualified_name="db_student.sales_data.sale_amount@Sandbox_storage",
        guid="-4",
        attributes={
            "type": "double",
            "owner": "hive"
